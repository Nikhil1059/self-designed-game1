...
function setup() {
  ...
  if(gamestate==="start")
  {
   intro1=createSprite(600,300);
   intro1.addImage(intro1i);
   intro1.scale=1.2;
   play=createSprite(600,500);
   play.addImage(playi);
   play.scale=0.8; 
  ...
  if(mousePressedOver(play)){
   ...
   life3.visible=true;
     ...
     if(mousePressedOver(reset)){
      ...
      gamestate = "play";
      score = 0;
      invplatformgrp.destroyEach();
      platformgrp.destroyEach();
      spikesgrp.destroyEach();
